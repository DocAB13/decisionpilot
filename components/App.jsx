      ...
      options: [
          ...
          options: [
            {
              ...
              result: {
                ...
                picks: [
                  { name: "Ksamil, Albania", tag: "Best Value", desc: "Crystal clear water, authentic food, almost zero crowds.", link: "https://www.booking.com/searchresults.html?ss=Ksamil" },
                  { name: "Sunny Beach, Bulgaria", tag: "Party Scene", desc: "Lively atmosphere, affordable hotels, warm Black Sea water.", link: "https://www.booking.com/searchresults.html?ss=Sunny+Beach" },
                  { name: "Ulcinj, Montenegro", tag: "Underrated", desc: "Long sandy beach, warm Adriatic water, very affordable.", link: "https://www.booking.com/searchresults.html?ss=Ulcinj" },
                ],
              },
            },
            {
              ...
              result: {
                ...
                picks: [
                  { name: "Crete, Greece", tag: "Best Overall", desc: "Diverse landscapes, incredible food, warm locals.", link: "https://www.booking.com/searchresults.html?ss=Crete" },
                  { name: "Mallorca, Spain", tag: "Best Nightlife", desc: "Stunning coves, world-class clubs, easy transport.", link: "https://www.booking.com/searchresults.html?ss=Mallorca" },
                  { name: "Algarve, Portugal", tag: "Hidden Gem", desc: "Dramatic cliffs, golden beaches, excellent seafood.", link: "https://www.booking.com/searchresults.html?ss=Algarve" },
                ],
              },
            },
            {
              ...
              result: {
                ...
                picks: [
                  { name: "Santorini, Greece", tag: "Most Iconic", desc: "Caldera sunsets, infinity pools, romantic atmosphere.", link: "https://www.booking.com/searchresults.html?ss=Santorini" },
                  { name: "Maldives", tag: "Ultimate Luxury", desc: "Overwater bungalows, private beaches, world-class diving.", link: "https://www.booking.com/searchresults.html?ss=Maldives" },
                  { name: "Bali, Indonesia", tag: "Best Value Luxury", desc: "Luxury at mid-range prices. Seminyak for nightlife, Ubud for culture.", link: "https://www.booking.com/searchresults.html?ss=Bali" },
                ],
              },
            },
          ],
          ...
          options: [
            {
              ...
              result: {
                ...
                picks: [
                  { name: "Rome, Italy", tag: "Most Historic", desc: "Colosseum, Vatican, incredible food.", link: "https://www.booking.com/searchresults.html?ss=Rome" },
                  { name: "Prague, Czech Republic", tag: "Best Value", desc: "Fairy-tale architecture, craft beer culture.", link: "https://www.booking.com/searchresults.html?ss=Prague" },
                  { name: "Lisbon, Portugal", tag: "Most Underrated", desc: "Trams, Fado music, epic Atlantic views.", link: "https://www.booking.com/searchresults.html?ss=Lisbon" },
                ],
              },
            },
            {
              ...
              result: {
                ...
                picks: [
                  { name: "Tokyo, Japan", tag: "Most Unique", desc: "Futuristic and traditional at once.", link: "https://www.booking.com/searchresults.html?ss=Tokyo" },
                  { name: "Kyoto, Japan", tag: "Most Traditional", desc: "Geishas, temples, bamboo forests.", link: "https://www.booking.com/searchresults.html?ss=Kyoto" },
                  { name: "Bangkok, Thailand", tag: "Best Value", desc: "Street food, temples, rooftop bars.", link: "https://www.booking.com/searchresults.html?ss=Bangkok" },
                ],
              },
            },
          ],
        },
        {
          ...
          result: {
            ...
            picks: [
              { name: "New Zealand", tag: "Best All-Round", desc: "Bungee jumping, hiking, hobbit holes.", link: "https://www.booking.com/searchresults.html?ss=New+Zealand" },
              { name: "Patagonia, Argentina", tag: "Most Dramatic", desc: "Torres del Paine, glaciers, end of the world.", link: "https://www.booking.com/searchresults.html?ss=Patagonia" },
              { name: "Norway", tag: "Best in Europe", desc: "Fjords, Northern Lights, midnight sun.", link: "https://www.booking.com/searchresults.html?ss=Norway" },
            ],
          },
        },
      ],
      ...
      options: [
        {
          ...
          result: {
            ...
            picks: [
              { name: "iPhone 16 Pro Max", tag: "Best Overall", desc: "Cinematic mode, ProRes video, titanium build.", link: "https://www.amazon.com/s?k=iPhone+16+Pro+Max" },
              { name: "Google Pixel 9 Pro", tag: "Best AI Camera", desc: "Google's AI magic makes every photo look professional.", link: "https://www.amazon.com/s?k=Google+Pixel+9+Pro" },
              { name: "Samsung Galaxy S25 Ultra", tag: "Most Versatile", desc: "200MP sensor, 10x optical zoom, S Pen included.", link: "https://www.amazon.com/s?k=Samsung+Galaxy+S25+Ultra" },
            ],
          },
        },
        {
          ...
          result: {
            ...
            picks: [
              { name: "OnePlus 13", tag: "Fastest Charging", desc: "100W charging, full charge in 25 minutes.", link: "https://www.amazon.com/s?k=OnePlus+13" },
              { name: "Samsung Galaxy S25+", tag: "Best Balance", desc: "All-day battery with premium features.", link: "https://www.amazon.com/s?k=Samsung+Galaxy+S25+" },
              { name: "iPhone 16 Plus", tag: "Best iOS Battery", desc: "2 days of normal use.", link: "https://www.amazon.com/s?k=iPhone+16+Plus" },
            ],
          },
        },
        {
          ...
          result: {
            ...
            picks: [
              { name: "Google Pixel 8a", tag: "Best Under $500", desc: "Flagship AI features, pure Android, excellent camera.", link: "https://www.amazon.com/s?k=Google+Pixel+8a" },
              { name: "Samsung Galaxy A55", tag: "Best Mid-Range", desc: "Beautiful display, solid camera, 5G.", link: "https://www.amazon.com/s?k=Samsung+Galaxy+A55" },
              { name: "Nothing Phone 3a", tag: "Most Unique", desc: "Glyph interface, clean design, excellent specs.", link: "https://www.amazon.com/s?k=Nothing+Phone+3a" },
            ],
          },
        },
      ],
